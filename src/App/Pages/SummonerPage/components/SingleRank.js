      ...
      <div className="rankItem">
        <h2>{rankInfo.queueType}</h2>
          ...
          <div className="stats">
            ...
            {rankInfo.points !== ""? <div className="points">{rankInfo.points === 100 ? `100LP  W:${rankInfo.miniSeries.wins}  L:${rankInfo.miniSeries.losses}` : `${rankInfo.points} LP`}</div> : <div className="points">-</div>}
          </div>
        </div>
  )
}
